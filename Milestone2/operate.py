...
class Operate:
    ...
    def control(self):
        ...
        if args.ip == 'localhost':  # simulation
            drive_meas = measure.Drive(lv, rv, dt)
        else:  # physical robot (right wheel reversed) with covariance
...
if __name__ == "__main__":
    ...
    parser.add_argument("--yolo_model", default='YOLO/model/V3.pt')
    ...
    pygame.display.set_caption('ECE4078 Lab (Merged M1+M2)')
